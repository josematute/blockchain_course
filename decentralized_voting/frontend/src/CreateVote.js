	...
	return (
		<Form className="m-2">
			...
			<Form.Group className="m-2">
				...
				<Form.Control type="text" name="uri" placeholder="IPFS URI" value={uri} onChange={(e) => setUri(e.target.value)} />
			</Form.Group>
			<Form.Group className="m-2">
				<label htmlFor="options">Number of Options</label>
				<Form.Control type="number" min={2} max={8} name="options" value={options} onChange={(e) => setOptions(e.target.value)} />
			</Form.Group>
			<Form.Group className="m-2">
