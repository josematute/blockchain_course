...
describe("DEX", () => {
	...
	describe("Buy", () => {
		...
		it("User cannot invalid number of tokens", async () => {
			await expect(dex.connect(addr1).buy(91, { value: 91000 })).to.be.reverted
		})

		it("User cannot buy with invalid number of tokens", async () => {
	...
	describe("Withdraw tokens", () => {
		...
		// just dex = dex.connect(owner) is the owner address, hence why it is not specified
